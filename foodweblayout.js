function foodweblayout() {
    ...
    function chart(selection) {
        selection.each(function(data, i) {
            ...
            // Color
            // c10: trophic groups (default for node face color)
            // col: node type outline (producer, detrital, fleet, etc.)
            // colscale: node facecolor if cval property found
                ...
                svg.selectAll('circles')
                  ...
                  .enter().append('svg:circle')
                    ...
                    .style("fill", function(d)   {
                        if ('cval' in d) {
                            return d.type >= 4 ? "white" : colscale(d.cval);
                        } else {
                            return d.type >= 4 ? "white" : c10(d.TG-1); 
                        }})
